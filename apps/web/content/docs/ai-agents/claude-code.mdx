...
claude mcp add --scope project vibe-check -- npx -y @wcgw/vibe-check-mcp@0.2.0 connect

# Make the bridge available in every project
claude mcp add --scope user vibe-check -- npx -y @wcgw/vibe-check-mcp@0.2.0 connect
```
