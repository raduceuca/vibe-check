...
const baseStyle = (size: 'sm' | 'md', copied: boolean): CSSProperties => ({
  ...
  fontSize: 14,
  fontWeight: 500,
  border: `1px solid ${copied ? 'rgba(74,222,128,0.2)' : 'rgba(var(--vc-fg,255,255,255),0.08)'}`,
  cursor: 'pointer',
  transition: 'background 0.2s ease, border-color 0.2s ease, color 0.2s ease',
  color: copied ? '#4ade80' : 'rgba(var(--vc-fg,255,255,255),0.6)',
  background: copied ? 'rgba(74,222,128,0.08)' : 'rgba(var(--vc-fg,255,255,255),0.03)',
  outline: 'none',
  fontFamily: 'inherit',
})
